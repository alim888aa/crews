...
function SidebarProvider({
  ...
  // Keep one capture listener across renders; React 19 cleans it up on unmount.
  const [connectShortcut] = React.useState(
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      aria-label={
        (isMobile ? openMobile : open) ? 'Hide sidebar' : 'Show sidebar'
      }
